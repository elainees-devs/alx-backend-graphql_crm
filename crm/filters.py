# Django filters for CRM application models
# This file defines filters for Customer, Product, and Order models using django_filters.
...
class OrderFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Order
        fields = ["total_amount", "order_date", "customer_name"]